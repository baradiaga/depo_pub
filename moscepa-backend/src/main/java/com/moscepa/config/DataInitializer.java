...
public class DataInitializer implements CommandLineRunner {
    ...
    createSousFonctionnalite("Liste formation", "gerer_inscriptions", "/app/enseignant/listeformation")
                ...
                createFonctionnalite("Gestion des questionnaires", "gestion_questionnaires", "help-circle",
                    ...
                    createSousFonctionnalite("liste Questionnaire", "creer_questionnaire", "/app/enseignant/listequestionnaire"),
    ...
    createSousFonctionnalite("Banque de ressources", "external_resources_bank", "/app/admin/external-resources/bank")),
                ...
                createFonctionnalite("Tutorat", "tutorat", "user-check",
                    createSousFonctionnalite("Mes étudiants", "mes_etudiants", "/app/tuteur/listeetudiant"),
                    createSousFonctionnalite("Suivi progression", "suivi_progression", "/app/tuteur/student"),
                    createSousFonctionnalite("Planifier séances", "planifier_seances", "/app/tuteur/tests")),
                createFonctionnalite("Enseignement", "enseignement", "graduation-cap",
                    createSousFonctionnalite("Mes cours", "mes_cours", "/app/enseignant/MesCours"),
                    createSousFonctionnalite("Créer contenu", "creer_contenu", "/app/enseignant/formations"),
                    createSousFonctionnalite("Évaluer étudiants", "evaluer_etudiants", "/app/enseignant/EvaluerEtudiant")),
