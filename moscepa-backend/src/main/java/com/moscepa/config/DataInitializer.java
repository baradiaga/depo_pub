...
public class DataInitializer implements CommandLineRunner {
        ...
        if (fonctionnaliteRepository.count() == 0) {
            ...
            List<Fonctionnalite> defaultFeatures = Arrays.asList(
                ...
                createFonctionnalite("Gestion des fonctionnalités", "gestion_fonctionnalites", "settings",
                    ...
                    createSousFonctionnalite("Liste des fonctionnalités", "liste_fonctionnalites", "/app/admin/features"),
                ...
                createFonctionnalite("Gestion des formations", "gestion_formations", "book",
                    createSousFonctionnalite("Créer formation", "creer_formation", "/app/admin/formations/create"),
                ...
                createFonctionnalite("Gestion des ressources pédagogiques", "gestion_ressources_pedagogiques", "folder",
                    createSousFonctionnalite("Créer ressource", "creer_ressource", "/app/technopedagogue/ressources/create"),
                    createSousFonctionnalite("Mes ressources", "mes_ressources", "/app/technopedagogue/ressources"),
                    createSousFonctionnalite("Bibliothèque", "bibliotheque", "/app/technopedagogue/ressources/library")),
    ...
    createSousFonctionnalite("Banque de ressources", "external_resources_bank", "/app/admin/external-resources/bank")),
                createFonctionnalite("Gestion des remédiation", "gestion_remediation", "refresh-cw",
                    ...
                    createSousFonctionnalite("Résultats", "resultats", "/app/student/resultats")),
