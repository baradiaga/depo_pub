...
public class DepartementWithRelationsDTO {
    ...
    private UefrSimpleDTO uefr; // ← Objet simplifié pour affichage
    ...
    public UefrSimpleDTO getUefr() { return uefr; }
    public void setUefr(UefrSimpleDTO uefr) { this.uefr = uefr; }
